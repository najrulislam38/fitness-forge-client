        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-5 text-center">
            ...
            <p className="text-black mt-7 mb-4 text-sm md:text-base">
              I love how easy it is to track my workouts with Fitness Forge. The
              accuracy is spot-on, and the goal-setting feature keeps me pushing
              my limits. It is like having a personal coach on my wrist!
            </p>
