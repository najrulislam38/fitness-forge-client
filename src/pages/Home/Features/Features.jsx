      ...
      <Container>
        <div>
          ...
          <div className="mt-10 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 ">
            <div className="  text-center px-5 py-8 border shadow-md ">
              <MdOutlineNotAccessible className="text-5xl  mx-auto text-[#e48f45] my-6" />
            ...
            <div className="  text-center px-5 py-8 border shadow-md ">
              <GoClock className="text-5xl  mx-auto text-[#e48f45] my-6" />
              <h3 className="text-base md:text-xl font-semibold pt-2">
            ...
            <div className="  text-center px-5 py-8 border shadow-md ">
              <FaCalendarAlt className="text-5xl  mx-auto text-[#e48f45] my-6" />
              <h3 className="text-base md:text-xl font-semibold pt-2">
                Flexible Prices
              </h3>
              <p className="py-3 text-sm md:text-base">
